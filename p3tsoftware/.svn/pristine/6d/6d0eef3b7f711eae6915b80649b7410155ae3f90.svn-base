...
public class HungarianAlgorithm {
	...
	public static void swtichStep(int [][] mask, double [][]cost, int step, int[]rowCover, int[]zero_RC, int []colCover, boolean done, double maxCost){
		switch (step)
		{
			case 1:
	...
	public static void ifSumMax(double[][] cost){
	...
	public static void assignment(int[][]mask, int[][]assignment){
	...
	public static int[][] hgAlgorithm(double[][] array, String sumType)
	{
		...
		{
			swtichStep(mask,cost,step,rowCover,zero_RC,colCover,done,maxCost);
		}//end while
