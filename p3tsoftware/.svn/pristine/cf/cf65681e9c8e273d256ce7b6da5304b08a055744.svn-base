...
public class DBServiceImpl implements DBService {
	...
	conn = DriverManager.getConnection(driverPrefix+"://"+conf.getIPAddress()+":"+conf.getPort()+"/"+conf.getDatabase(), conf.getUser(), conf.getDbpass());
	return conn;
    }
