...
public class XMLMetadataRendererVisitor extends GenericReflectiveVisitor implements AlignmentVisitor {
    ...
    public void forCicle(Alignment align, String extensionString){
        int gen = 0;
    ...
    public void ifNewStyle(Alignment align) throws AlignmentException {
        BasicAlignment Alignb = (BasicAlignment) align;
        if ( newstyle ){
            writer.print("  <onto1>\n    <Ontology");
            ...
            if ( align instanceof BasicAlignment && Alignb.getOntologyObject1().getFormalism() != null ) {
                writer.print("\n      <formalism>\n        <Formalism align:name=\""+Alignb.getOntologyObject1().getFormalism()+"\" align:uri=\""+Alignb.getOntologyObject1().getFormURI()+"\"/>\n      </formalism>");
            }
            writer.print("\n    </Ontology>\n  </onto1>\n");
            writer.print("  <onto2>\n    <Ontology");
            ...
            if ( align instanceof BasicAlignment && Alignb.getOntologyObject2().getFormalism() != null ) {
                writer.print("\n      <formalism>\n        <Formalism align:name=\""+Alignb.getOntologyObject2().getFormalism()+"\" align:uri=\""+Alignb.getOntologyObject2().getFormURI()+"\"/>\n      </formalism>");
            }
            writer.print("\n    </Ontology>\n  </onto2>\n");
        }
    }
	...
	// Get the keys of the parameter
        ...
        this.forCicle(align, extensionString);
