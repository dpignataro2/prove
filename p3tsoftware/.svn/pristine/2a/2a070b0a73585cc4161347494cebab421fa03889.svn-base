...
public class HTMLMetadataRendererVisitor extends GenericReflectiveVisitor implements AlignmentVisitor {
	...
	public void controlFile1Align(Alignment align){
		BasicAlignment align1 = (BasicAlignment) align;
		...
		if ( align instanceof BasicAlignment && align1.getOntologyObject1().getFormalism() != null ) {
			writer.print("<tr><td>type:</td><td><span rel=\"align:formalism\"><span typeof=\"align:Formalism\"><span property=\"align:name\">"+align1.getOntologyObject1().getFormalism()+"</span><span property=\"align:uri\" content=\""+align1.getOntologyObject1().getFormURI()+"\"/></span></span></td></tr>");
		}
	}
	...
	public void controlFile2Align(Alignment align){
		...
		if ( align instanceof BasicAlignment && align1.getOntologyObject2().getFormalism() != null ) {
			writer.print("<tr><td>type:</td><td><span rel=\"align:formalism\"><span typeof=\"align:Formalism\"><span property=\"align:name\">"+align1.getOntologyObject2().getFormalism()+"</span><span property=\"align:uri\" content=\""+align1.getOntologyObject2().getFormURI()+"\"/></span></span></td></tr>");
		}
	}
