...
public class SILKRendererVisitor extends GraphPatternRendererVisitor implements AlignmentVisitor{
    ...
    public void ifEmbeddedBlanksWeakens(Properties p){
	 ...
	 * @param p
	 */
	public void ifIgnoreThresholdLimit(Properties p){
	 ...
	 * @param p
	 */
	public void ifIndentNl(Properties p){
    ...
    public void init( Properties p ) {
    	...
    	this.ifEmbeddedBlanksWeakens(p);

		this.ifIgnoreThresholdLimit(p);
	 ...
	 * @param gen
	 */
    public void ifPrefixAlign(Alignment align, String extensionString,int gen){
	 ...
	 */
	public void ifAlignBasic(Alignment align) throws AlignmentException {
	...
	/**
	 * void ifEmbeddedFalse()
	 */
	public void ifEmbeddedFalse(){
		if ( embedded == false ) {
	...
	nslist.put( Namespace.XSD.prefix , Namespace.XSD.shortCut );
    	...
    	this.ifPrefixAlign(align,extensionString,gen);

    	this.ifEmbeddedFalse();
