...
public class RDFRendererVisitor extends IndentedRendererVisitor implements AlignmentVisitor,EDOALVisitor {
    ...
    public void forStringAlignExt(Alignment align, int gen, String extensionString){
	...
	public void ifAlignBasicAlign(Alignment align){
	...
	public void ifEmbeddedEqualsFalse(){
		if ( embedded == false ) {
	...
	public void ifAlignBasicAlignA(Alignment align) throws AlignmentException {
		if ( align instanceof BasicAlignment ) {
	...
	public void forCellInAlign(Alignment align) throws AlignmentException {
    ...
    public void visit( Alignment align ) throws AlignmentException {
		...
		this.forStringAlignExt(align, gen, extensionString);

		this.ifEmbeddedEqualsFalse();
    ...
    public void if2ED0AL(Cell cell) throws AlignmentException {
	...
	public void ifCellEDOALCell(Set<Transformation> transfs) throws AlignmentException {
		if ( transfs != null ) {
	...
	public void ifCellExNotNull(Cell cell){
	...
	public void ifAlign2EDOAL(Cell cell) throws AlignmentException {
		...
		if ( cell instanceof EDOALCell ) { // Here put the transf
			...
			this.ifCellEDOALCell(transfs);
		}
	}

	public void ifCellSemanticNotNull(Cell cell){
	...
	public void ifCellIdNotNull(Cell cell,URI u1, URI u2) throws AlignmentException {
	...
	public void ifCellExtNotNull(Cell cell){
		if ( cell.getExtensions() != null ) {
			for ( String[] ext : cell.getExtensions() ){
				this.ifCellExNotNull(cell);
			}
		}
	}
	...
	if ( ( u1 != null && u2 != null) || alignment.getLevel().startsWith("2EDOAL") ){
	    ...
	    this.ifCellIdNotNull(cell,u1,u2);
	    ...
	    this.ifCellSemanticNotNull(cell);

	    this.ifCellExtNotNull(cell);
